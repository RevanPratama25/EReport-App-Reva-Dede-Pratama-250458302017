    ...
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div class="px-4 py-8 bg-white shadow sm:rounded-lg sm:px-10">
            <form wire:submit.prevent="register">
                <div>
                    <label for="whatsapp" class="block text-sm font-medium text-gray-700 leading-5">
                        No Whatsapp
                    </label>

                    <div class="mt-1 rounded-md shadow-sm">
                        <input wire:model.lazy="whatsapp" id="whatsapp" type="text" required autofocus class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:ring-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5 @error('whatsapp') border-red-300 text-red-900 placeholder-red-300 focus:border-red-300 focus:ring-red @enderror" />
                    </div>
                        {{-- wire:model.lazy="whatsapp"   based on register.php --}}
                    @error('whatsapp')
