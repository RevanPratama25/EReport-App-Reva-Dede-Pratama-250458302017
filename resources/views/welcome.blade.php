      ...
      <div class="container mx-auto px-4 py-4">
        <div class="flex items-center justify-between">
          ...
          <div class="flex items-center gap-4">
            <a href="{{ route ('login') }}"><button class="border border-gray-300 text-gray-700 px-4 py-2 rounded-md text-sm hover:bg-gray-100">Masuk</button></a>
            <a href="{{ route ('register') }}"><button class="bg-blue-600 text-white px-4 py-2 rounded-md text-sm hover:bg-blue-700">Daftar</button></a>
    ...
    <section class="py-20 px-4">
      <div class="container mx-auto text-center max-w-4xl">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <button class="border border-gray-300 text-gray-700 text-lg px-8 py-6 rounded-md hover:bg-gray-100">Lihat Status Laporan</button>
        </div>
      </div>
    </section>
