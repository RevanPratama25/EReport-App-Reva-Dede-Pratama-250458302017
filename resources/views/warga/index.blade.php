...
{{-- 
  CATATAN: 
  Pastikan file `layouts.app.blade.php` Anda memiliki <body class="bg-slate-950 text-slate-300"> 
  Ini akan mengatur default latar belakang dan warna teks untuk seluruh halaman.
--}}
...
@section('content')
        ...
        <div class="container mx-auto px-4 py-4">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-xl font-bold text-white">ReportApp</h1>
                ...
                <div class="flex items-center">
                    @auth
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit"
                                class="text-slate-100 hover:text-white px-4 py-2 rounded-md font-medium text-sm transition-colors duration-200 bg-red-600 hover:bg-red-500">
                                Logout
                            </button>
                        </form>
                    @else
                        <a href="{{ route('login') }}"
                            class="text-slate-300 hover:text-blue-400 px-3 py-2 rounded-md font-medium text-sm transition-colors duration-200">
                            Login
                        </a>
                    @endauth
                </div>
    ...
    <section class="py-24 md:py-32 px-4 bg-slate-950">
        <div class="container mx-auto text-center max-w-4xl">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                {{-- PERBAIKAN: Mengubah <button><a>...</a></button> menjadi <a>...</a> agar valid --}}
                <a href="#form"
                    class="bg-blue-600 text-white text-lg px-8 py-5 rounded-lg inline-flex items-center justify-center hover:bg-blue-500 transition-colors duration-200 shadow-xl shadow-blue-600/30 hover:shadow-blue-500/40 transform hover:-translate-y-1">
                    <!-- Icon -->
                 ...
                 {{-- PERBAIKAN: Mengubah <button><a>...</a></button> menjadi <a>...</a> agar valid --}}
                <a href="#list-laporan" {{-- Saya tambahkan ID agar link ini berfungsi --}}
                    class="border border-slate-700 text-slate-300 text-lg px-8 py-5 rounded-lg inline-flex items-center justify-center hover:bg-slate-800 hover:text-slate-100 hover:border-slate-600 transition-colors duration-200 transform hover:-translate-y-1">
    ...
    <!-- Form Laporan (Livewire) -->
    <section id="form" class="py-20 px-4 bg-slate-900">
        {{-- Komponen Livewire Anda akan mewarisi latar belakang gelap ini --}}
        @livewire('laporan-create')
    </section>

    {{-- Menghapus <hr> yang tidak diperlukan --}}

    <!-- List Laporan (Livewire) -->
    <section id="list-laporan" class="py-20 px-4 bg-slate-950">
        {{-- Komponen Livewire Anda akan mewarisi latar belakang gelap ini --}}
    ...
    <footer class="border-t border-slate-800 bg-slate-900 py-12 px-4">
        <div class="container mx-auto max-w-6xl">
            <div class="grid md:grid-cols-4 gap-12">
                <div>
                    <div class="flex items-center gap-3 mb-4">
                        ...
                        <span class="font-bold text-white">ReportApp</span>
                    </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-sm text-slate-400">
                        <li><a href="#form" class="hover:text-blue-400 transition-colors">Buat Laporan</a></li>
                        <li><a href="#list-laporan" class="hover:text-blue-400 transition-colors">Cek Status</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-sm text-slate-400">
                        ...
                        <li><a href="tel:0211234567" class="hover:text-blue-400 transition-colors">(021) 123-4567</a>
                        </li>
            ...
            <div class="border-t border-slate-800 mt-10 pt-8 text-center text-sm text-slate-500">
                <p>&copy; 2024 ReportApp. Semua hak dilindungi undang-undang.</p>
            </div>
        </div>
    </footer>
@endsection
